...
### Keep SKILL.md lean
- Official ceiling: <500 lines
- Practical target: <100 lines for most skills
- Beyond 100 lines, you're usually encoding logic that should be in a script or referenced file
